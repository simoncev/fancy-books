		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fancy book",
									"targetURL": "#comspaiensfancybook-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comspaiensfancybook-display": {
								"semanticObject": "comspaiensfancybook",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.spaiens.fancybook",
									"url": sap.ui.require.toUrl("com/spaiens/fancybook")
								}
							}
						}
					}
